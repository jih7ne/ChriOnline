...
public class PaiementService {
    ...
    // 🔒 Garde d'immuabilité: utilisé pour toutes les vérifications de paiement confirmé
    ...
    public boolean enregistrerPaiement(int idCommande, String numeroCarte,
        ...
        // 🔒 SÉCURITÉ: Délègue la vérification du double paiement au PaymentImmutabilityGuard
        PaymentImmutabilityGuard.assertNoDuplicatePayment(
            paiementRepository.existsByCommandeId(idCommande), idCommande
        );
    ...
    public void modifierPaiement(int idPaiement, int idUtilisateur, Paiement nouveauxDetails) {
        ...
        // 🔒 Délègue toutes les vérifications d'immuabilité au PaymentImmutabilityGuard
        PaymentImmutabilityGuard.assertNotConfirmed(existing);
